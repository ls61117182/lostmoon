...
async function main(){
 ...
 const artRes=await sharp(path.join(dir,'tiger-normal-preview-v5-blueprint.png')).resize({width:Math.round(1949*scale)}).ensureAlpha().raw().toBuffer({resolveWithObject:true});
 ...
 fs.writeFileSync(path.join(dir,'comparison-overlay-v5.png'),o);
 ...
 fs.writeFileSync('C:/Users/Administrator/.codex/visualizations/2026/09/08/01a080f0-6d5a-7042-ae40-b77e02f90513/tiger-overlay-v5.html',html);
