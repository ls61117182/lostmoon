...
const REQUIRED_KINDS = ['sherman', 'sherman76', 'sherman_jumbo', 'm26_pershing', 't34', 't34_85', 'su152', 'tiger', 'tigerking', 'maus', 'panther', 'panzer4', 'stug3', 'panzer3', 'panzer3_m', 'type97', 'type95', 'type4', 'at_gun', 'pak38', 'flak88', 'heavy_artillery', 'german_heavy_artillery', 'truck'];
const SPLIT_KINDS = ['sherman', 'sherman76', 'sherman_jumbo', 'm26_pershing', 't34', 't34_85', 'tiger', 'tigerking', 'maus', 'panther', 'panzer4', 'panzer3', 'panzer3_m', 'type97', 'type95', 'type4', 'flak88', 'heavy_artillery', 'german_heavy_artillery'];
const NUM_FIELDS = [
  'fitScale',
  'offsetForward',
  'offsetRight',
...
function build() {
  ...
  for (const kind of SPLIT_KINDS) {
    const r = byKind.get(kind);
    lines.push(`  ${kind}: { hullFitScale: ${emitNum(r.hullFitScale)}, turretScale: ${emitNum(r.turretScale)}, hullOffsetForward: ${emitNum(r.hullOffsetForward)}, hullOffsetRight: ${emitNum(r.hullOffsetRight)}, turretOffsetForward: ${emitNum(r.turretOffsetForward)}, turretOffsetRight: ${emitNum(r.turretOffsetRight)}, commanderHatchSpriteX: ${emitNum(r.commanderHatchSpriteX)}, commanderHatchSpriteY: ${emitNum(r.commanderHatchSpriteY)}, commanderHatchScale: ${emitNum(r.commanderHatchScale)} },`);
  }
  lines.push('};');
  lines.push('');
