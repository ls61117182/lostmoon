...
export const DAMAGE_TABLE: Record<DamageTargetClass, Record<DamageCheckType, Record<number, DamageTableEntry>>> = {
  ...
  protagonist: {
    ...
    right: {
      ...
      4: { targetClass: 'protagonist', damageCheckType: 'right', die: 4, groups: [[{"kind":"turret"}],[{"kind":"fire"}]], notes: "" },
    ...
    left: {
      ...
      4: { targetClass: 'protagonist', damageCheckType: 'left', die: 4, groups: [[{"kind":"turret"}],[{"kind":"fire"}]], notes: "" },
