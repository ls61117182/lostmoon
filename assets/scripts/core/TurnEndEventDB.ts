...
export const TURN_END_EVENTS: TurnEndEventRow[] = [
  ...
  { missionId: 'mission_test', sumMin: 2, sumMax: 3, diceCount: 2, effectType: 'tiger_spawn', reinforcementSide: 'enemy' },
  { missionId: 'mission_test', sumMin: 4, sumMax: 4, diceCount: 2, effectType: 'sherman_spawn', reinforcementSide: 'friendly' },
  { missionId: 'mission_test', sumMin: 5, sumMax: 6, diceCount: 2, effectType: 'infantry_spawn', reinforcementSide: 'enemy' },
  ...
  { missionId: 'mission_test', sumMin: 11, sumMax: 12, diceCount: 2, effectType: 'panzer3_spawn', reinforcementSide: 'enemy' },
