...
const TANK_VISUAL_CONFIG: Record<TankVisualKind, TankVisualConfig> = {
  ...
  panther: { fitScale: 0.82, offsetForward: 0, offsetRight: 0, aspectRatioMul: 1, muzzle: { spriteX: 0, spriteY: 17 }, destroyedOffsetForward: 0, destroyedOffsetRight: 0, destroyedFitScale: 1 },
...
const SPLIT_TANK_VISUAL_CONFIG: Record<SplitTankKind, SplitTankVisualConfig> = {
  ...
  panther: { hullFitScale: 0.84, turretScale: 0.82, hullOffsetForward: 0, hullOffsetRight: 0, turretOffsetForward: 0, turretOffsetRight: 0, commanderHatchSpriteX: 72, commanderHatchSpriteY: 22, commanderHatchScale: 14 },
...
const SPLIT_TANK_GEOMETRY_CONFIG: Record<SplitTankKind, SplitTankGeometryConfig> = {
  ...
  panther: {
    topTrim: { x: 0, y: 0, w: 100, h: 46 },
    turretTrim: { x: 0, y: 0, w: 95, h: 34 },
    pivot: { bodyX: 50, bodyY: 23, spriteX: 72, spriteY: 17 },
    muzzle: { spriteX: 0, spriteY: 17 },
  },
  panzer4: {
    topTrim: { x: 0, y: 0, w: 100, h: 50 },
