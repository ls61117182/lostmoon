...
assert(
  buildMethod[0].includes('STATUS_CREW_START_X + (i % STATUS_CREW_COLUMNS) * (STATUS_CREW_ICON_SIZE + STATUS_CREW_ICON_GAP)'),
  'Crew status icon placeholders should wrap after five columns',
);
assert(
