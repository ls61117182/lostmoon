...
assert.match(visuals, /topTrim: \{ x: 0, y: 0, w: 256, h: 137 \}/, 'panther hull must preserve the selected source aspect ratio at high pixel density');
assert.match(visuals, /turretTrim: \{ x: 0, y: 0, w: 249, h: 106 \}/, 'panther turret geometry must preserve the selected long-gun source aspect ratio');
assert.match(visuals, /pivot: \{ bodyX: 110, bodyY: 69, spriteX: 189, spriteY: 53 \}/, 'panther pivots must match the high-density selected hull and turret');
